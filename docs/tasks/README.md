...
- **56 detectors** across 4 chains + cross-chain dependency/build analysis
  - Solana: 16 (SOL-001 through SOL-016)
...
- Intra-file call graph analysis for FP reduction (helper functions called from checked entry points)
